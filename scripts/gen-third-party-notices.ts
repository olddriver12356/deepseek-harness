...
/**
 * Fusion Pixel dropped 2026-09-04: the shipped display fonts fall back to
 * var(--dsw-font-family) instead (see Boujoy Panel Scaffolding Pitfalls),
 * so only the still-bundled collage artwork is a real notice-worthy asset.
 */
