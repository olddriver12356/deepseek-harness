...
/**
 * Select the latest Workspace, breaking ties by Host order.
 * @param workspaces - Workspace membership and creation timestamps.
 * @param sessions - Session update timestamps indexed by id.
 * @returns most recently active Workspace, or undefined for an empty list.
 */
