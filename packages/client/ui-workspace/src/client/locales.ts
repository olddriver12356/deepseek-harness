...
export const zh = {
  ...
  'section.sessions': '会话',
  'section.projectTape': 'PROJECT TAPE',
  'section.sessionTape': '会话磁带',
  ...
  'workspace.add': '添加工作区',
  'currentWorkspace.label': '当前工作区',
  'currentWorkspace.menu': '切换工作区',
  'currentWorkspace.loading': '正在加载…',
  'currentWorkspace.none': '未选择工作区',
  'currentWorkspace.value': '正在使用 {name}',
...
export const en = {
  ...
  'section.projectTape': 'PROJECT TAPE',
  'section.sessionTape': 'SESSION TAPE',
  ...
  'currentWorkspace.menu': 'Switch workspace',
  'currentWorkspace.loading': 'Loading…',
  'currentWorkspace.none': 'No workspace selected',
  'currentWorkspace.value': 'Using {name}',
  'search.sessions.aria': 'Search sessions',
  'search.placeholder': 'Search session content…',
  ...
  'sessions.total': '{n} sessions total',
