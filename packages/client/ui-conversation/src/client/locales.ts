...
export const zh = {
  ...
  'busy.running': '任务运行中',
  'busy.mode.steer': '↳ 引导当前任务',
  'busy.mode.queue': '排到下一条',
  'busy.mode.active': '当前发送模式：{mode}',
  'access.readOnly': '只读',
  ...
  'message.author.agent': '智能体',
  'chat.loadingHistory.kicker': '会话',
...
export const en = {
  ...
  'placeholder.default': 'Describe what you want to accomplish…',
  ...
  'placeholder.hero': 'Describe what you want to accomplish…',
  'placeholder.workspace': 'Choose a workspace to start',
  'input.commands': 'Commands',
  'input.attachImages': 'Add images',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter steers all queued messages',
  'input.accessMode': 'Access mode, current: {name}',
  'busy.running': 'Task running',
  'busy.mode.steer': '↳ Steer current task',
  'busy.mode.queue': 'Queue next',
  'busy.mode.active': 'Current send mode: {mode}',
  ...
  'chat.loadingHistory.kicker': 'Session',
