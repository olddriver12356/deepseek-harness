...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    occupants: [
      'client-ui-app-rail AppRail',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'app.rail\', () => ctx.slots.register(\n      { name: \'app.rail\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-shell/src/client/index.ts:52',
  },
  {
    key: 'conversation',
    kind: 'single',
    ...
    source: 'packages/client/ui-shell/src/client/index.ts:76',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-shell/src/client/index.ts:86',
  },
  {
    key: 'root',
    kind: 'single',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Session-aware right activity surface; independent from tool details.',
    doc: 'Session-aware right activity surface; independent from tool details.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-shell), so it exists while that entry is mounted',
    occupants: [
      'client-ui-shell LiveSignalPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shell.activity\', () => ctx.slots.register(\n      { name: \'shell.activity\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-shell/src/client/index.ts:88',
  },
  {
    key: 'shell.overlay',
    kind: 'list',
    ...
    declaredBy: 'an entry in \'root\' (client-ui-shell), so it exists while that entry is mounted',
    occupants: [
      'client-ui-app-rail ProofPanel id \'ui-app-rail-proof-panel\'',
      'client-ui-experts ExpertsPanel id \'experts-panel\'',
    ...
    source: 'packages/client/ui-shell/src/client/index.ts:99',
  },
  {
    key: 'sidebar',
    kind: 'single',
    ...
    source: 'packages/client/ui-shell/src/client/index.ts:63',
  },
  {
